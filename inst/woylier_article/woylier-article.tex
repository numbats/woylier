...
\caption{Plane to plane interpolation (left) and Frame to frame interpolation (right). We used dog_index for illustration purposes. For some non-linear index orientation of data could affect the index.}(\#fig:dogs)
\end{figure}
...
\begin{figure}
\centering
\includegraphics{woylier_article_files/figure-latex/currency-1.pdf}
