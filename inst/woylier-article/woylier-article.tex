...
\title{woylier: Generate a tour of multivariate data using frame to frame interpolation}
...
\begin{figure}
\includegraphics{woylier-article_files/figure-latex/splines2d-static-1} \caption{The plot on the right-hand side is a 30-degree rotation of the left-hand side. The calculated splines index is shown on top of each plot. Although they depict the same points we can see that the splines index is different which shows the rotational variance of the splines index.}\label{fig:splines2d-static}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{woylier-article_files/figure-latex/currency-1.pdf}
...
\begin{figure}
\centering
\includegraphics{woylier-article_files/figure-latex/currency-corr-1.pdf}
...
{\centering \includegraphics[width=0.5\linewidth]{woylier-article_files/figure-latex/pca-result-1} 

}

\caption{There is a strong non-linear dependence between PC1 and PC2.}\label{fig:pca-result}
\end{figure}
...
\caption{Guided tour optimization of splines index using Givens interpolation.}\label{fig:guided-givens-static}
\end{figure}
...
\caption{Guided tour optimization of splines index using Givens interpolation with search_better_random.}\label{fig:guided-givens-random-static}
\end{figure}
