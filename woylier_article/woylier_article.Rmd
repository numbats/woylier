...
knitr::include_graphics("sine_anim_givens.gif")
```
...
```{r geodesic-path, echo = FALSE, fig.height = 3, fig.cap="Geodesic interpolation path to target frame", include=knitr::is_html_output(), eval=knitr::is_html_output(), fig.alt = "Data rotating to sine curve."}

knitr::include_graphics("sine_anim_geodesic.gif")
```
